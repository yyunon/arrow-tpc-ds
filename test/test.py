from TPCDATASET.dataset import store_sales,store
...
ss = [0,4,6,7,10,13,22]
ss_obj = store_sales(columns = ss, row_size = 20, metadata_information=ss_metadata, field_metadata=field_metadata, metadata_indexes=ss).stream_to_file()
##
...
s_metadata = {b'fletcher_mode': b'read',
              b'fletcher_name': b's'}
s=[0]
s_obj = store(columns = s,row_size = 20, metadata_information=s_metadata, field_metadata=field_metadata, metadata_indexes=s).stream_to_file()
##
